...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
    ...
    public FirebaseListAdapter(ArrayList<T> mArrayList, Class<T> mModelClass, int mLayout, Activity activity) {
    ...
    public Query getmRef() {
        return mRef;
    }

    public Class<T> getmModelClass() {
        return mModelClass;
    }
    ...
    public void setmModels(List<T> mModels) {
    ...
    public ChildEventListener getmListener() {
        return mListener;
    }
